...
**Jelenlegi stabil fejlesztési ág: v0.5.4**.
...
### v0.5.4 — Kategorizált interakciós rendszer
...
### v0.5.4 — Kapcsolati osztályok és HUD navigáció
...
### v0.5.4 — HUD navigáció és karakterosztályok

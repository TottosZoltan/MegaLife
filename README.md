...
**Jelenlegi stabil fejlesztési ág: v0.5.2**.
...
### v0.5.2 — Kategorizált interakciós rendszer
...
### v0.5.2 — Kapcsolati osztályok és HUD navigáció
...
### v0.5.2 — HUD navigáció és karakterosztályok

...
**Jelenlegi stabil fejlesztési ág: v0.5.5**.
...
### v0.5.5 — Kategorizált interakciós rendszer
...
### v0.5.5 — Kapcsolati osztályok és HUD navigáció
...
### v0.5.5 — HUD navigáció és karakterosztályok
...
### v0.5.5 — Főoldal + hierarchikus menürendszer

...
**Jelenlegi stabil fejlesztési ág: v0.5.3**.
...
### v0.5.3 — Kategorizált interakciós rendszer
...
### v0.5.3 — Kapcsolati osztályok és HUD navigáció
...
### v0.5.3 — HUD navigáció és karakterosztályok
